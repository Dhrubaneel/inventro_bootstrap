...
export class InventroBootstrapInitStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const inventro_shopping_list_api_resource_remove_method = new ApiResource(this, 'InventroShoppingListApiResourceRemoveMethod', {
      restApi: inventro_api.restApi,
      parentResource: inventro_shopping_list_api_resource,
      resourcePath: INVENTRO_SHOPPING_LIST_ENDPOINT_PATH_REMOVE,
      lambdaFunction: inventro_service.function,
      httpMethod: 'POST',
      requestTemplate: generateRequestTemplate('removeCustomShoppingItems'),
      integrationResponses: getDefaultIntegrationResponses(),
      methodResponses: getDefaultMethodResponses()
    });
    ...
    const inventro_shopping_list_api_resource_get_list_method = new ApiResource(this, 'InventroShoppingListApiResourceGetMethod', {
      restApi: inventro_api.restApi,
      parentResource: inventro_shopping_list_api_resource,
      resourcePath: INVENTRO_SHOPPING_LIST_ENDPOINT_PATH_GET_LIST,
      lambdaFunction: inventro_service.function,
      httpMethod: 'POST',
      requestTemplate: generateRequestTemplate('syncShoppingList'),
      integrationResponses: getDefaultIntegrationResponses(),
      methodResponses: getDefaultMethodResponses()
    });
    ...
    addTagsToResources(
      [
        ...
        inventro_shopping_list_api_resource_remove_method
      ],
      { 'Project': 'Inventro' }
    );
  }
